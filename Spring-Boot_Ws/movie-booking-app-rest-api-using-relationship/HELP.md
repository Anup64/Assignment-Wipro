...
* The original package name 'com.example.movie-booking-app-rest-api-using-relationship' is invalid and this project uses 'com.example.movie_booking_app_rest_api_using_relationship' instead.
