...
* The original package name 'com.example.movie-ticket-booking-app-rest-api' is invalid and this project uses 'com.example.movie_ticket_booking_app_rest_api' instead.
